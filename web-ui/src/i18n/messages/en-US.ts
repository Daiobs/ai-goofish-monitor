...
const enUS = {
  ...
  results: {
    ...
    decisionQueue: {
      ...
      description: 'Review candidates by AI classification and comparability, with the strongest items ready for human verification first.',
      currentViewCount: '{count} items in this view',
      loadingSummary: 'Summarizing task results...',
      summaryLabel: 'Overall task result summary',
      emptyWorthViewing: 'No AI-recommended, comparable standalone target items right now.',
      tabs: {
        worth_viewing: 'Worth Viewing',
        comparable_targets: 'Comparable Targets',
        bundles: 'Bundles',
        excluded: 'Excluded',
        ai_issues: 'AI Issues',
      },
      summary: {
        ...
        aiNotRecommended: 'AI Not Recommended',
        aiIssues: 'AI Issues',
      },
    },
    grid: {
    ...
    insights: {
      defaultTitle: 'Price Trend Insight',
      subtitle: 'Comparable prices include only AI-confirmed standalone target products with an unambiguous unit price.',
      legacySubtitle: 'Compatibility mode summarizes keyword snapshots without AI product-category or unit-price validation.',
      currentAvg: 'Current Comparable Avg',
      historyAvg: 'Historical Comparable Avg',
      currentMin: 'Current Comparable Low',
      legacyCurrentAvg: 'Current Keyword Avg',
      legacyHistoryAvg: 'Historical Keyword Avg',
      legacyCurrentMin: 'Current Keyword Low',
      ...
      trendReading: 'Non-target products, bundles, other models, and ambiguous prices are excluded from market statistics.',
      legacyTrendReading: 'These prices use keyword-compatible samples and require manual validation of product type and unit price.',
      comparisonScope: '{comparable} comparable products included; {excluded} non-comparable candidates excluded.',
      keywordScope: '{count} products are included under keyword-compatible pricing.',
    ...
    card: {
      ...
      marketAvg: 'Target Comparable Avg',
      keywordMarketAvg: 'Keyword Sample Avg',
      historicalLow: 'Historical Low',
      targetOnly: 'Target: standalone target product',
      targetBundle: 'Bundle containing charger',
      notTarget: 'Not the target product',
      targetUncertain: 'Product type uncertain',
      targetUnclassified: 'Product not classified',
      comparable: 'Included in comparable prices',
      notComparable: 'Excluded from comparable prices',
      excludedFromMarket: 'Excluded from average',
      exclusionReason: 'Exclusion reason',
      bundleExclusion: 'Bundles are excluded from the standalone target decision queue.',
      nonTargetExclusion: 'AI classified this as a non-target product.',
      uncertainExclusion: 'The product type cannot yet be identified reliably.',
      nonComparableExclusion: 'Its price basis or product state is not suitable for market comparison.',
      aiIssueExclusion: 'AI analysis has not completed successfully, so this item is not in the decision queue yet.',
      marketPosition: 'Market position',
      belowMedian: '{percent}% below the comparable market median',
      aboveMedian: '{percent}% above the comparable market median',
      atMedian: 'Near the comparable market median',
      marketPositionUnavailable: 'Comparable market position is not available',
      excludedMarketPosition: 'Not included in comparable market positioning',
      anonymous: 'Anonymous',
      detail: 'Open',
      hidden: 'Hidden',
  ...
  settings: {
    ...
    ai: {
      ...
      modelPreset: 'OpenAI Model',
      modelPresetPlaceholder: 'Select a model',
      modelPresetHint: 'The bare GPT-5.6 alias maps to Sol; Terra and Luna use their exact model IDs.',
      customModelCurrent: 'Custom: {model}',
      modelName: 'Exact Model ID',
      modelNameHint: 'You can enter another OpenAI-compatible model ID supported by your provider.',
      notSelected: 'No model selected',
      reasoningEffort: 'Reasoning Effort',
      reasoningPlaceholder: 'Select reasoning effort',
      reasoningHint: 'Higher effort can improve difficult judgments while increasing latency and reasoning tokens.',
      reasoningOptions: {
